...
{
    public partial class UserProductionSettingsUserControl : ucBaseUserControl
    {
        ...
        public UserProductionSettingsUserControl()
        {
            InitializeComponent();
        ...
        protected virtual void LoadUserInfo(object sender, LoadUserModulesRequestEventArgs e)
        {
            ...
            //tlSectionsBook.ParentFieldName = "ReportToSectionID";
            ...
            //tlSectionsReport.ParentFieldName = "ReportToSectionID";
