...
{
    public partial class ucProblemPump : ucBaseUserControl
    {
        public ucProblemPump()
        {
            InitializeComponent();
        }
        ...
        {
            AddProbPumpFrm AddProbFrm = new AddProbPumpFrm();
        ...
        private void ucProblemPump_Load(object sender, EventArgs e)
        {
            LoadGrid();
        }
        ...
        void LoadGrid()
        {
            ...
            _dbMan.SqlStatement = "select a.*, b.ProbCatDesc from (\r\n " +
                         " select * from tbl_ProblemsPumpStation )a  \r\n" +
                         " left outer join(  \r\n" +
                         " select * from tbl_ProbCatagoriesPumpStation)b \r\n" +
