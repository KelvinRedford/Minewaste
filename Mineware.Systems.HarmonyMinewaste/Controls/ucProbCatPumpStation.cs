...
{
    public partial class ucProbCatPumpStation : ucBaseUserControl
    {
        public ucProbCatPumpStation()
        {
            InitializeComponent();
        }

        private void ucProbCatPumpStation_Load(object sender, EventArgs e)
        {
            LoadGrid();
        }
        ...
        void LoadGrid()
        {
            ...
            _dbMan.SqlStatement = "select * from tbl_ProbCatagoriesPumpStation\r\n " +
        ...
        {
            AddProbCatPump AddProbCatFrm = new AddProbCatPump();
