...
namespace Mineware.Systems.Minewaste
{
    ...
    public partial class GetImage : DevExpress.XtraEditors.XtraForm
    {
        ...
        public GetImage()
        {
            ...
            imageDir = @"\\zacddat02.ag.ad.local\MineWarePics$\Mineware.Systems.MinewasteImages";		// set initial image directory
        ...
        private void OpenViewport()
        {
            ...
            date = Convert.ToInt64(DateTime.Now.ToBinary());//Convert.ToInt64(DateTime.Now.ToBinary());
        ...
        public void loadReport()
        {
            ...
            //_dbManEmptyCubby.ConnectionString = _theConnection
        ...
        public void SaveImage()
        {
            ...
            _dbManSave.ConnectionString = _theConnection;
            _dbManSave.SqlStatement = "";      

                _dbManSave.SqlStatement = _dbManSave.SqlStatement + "  BEGIN TRY insert into  tbl_PlanningImages values ( \r\n";
                _dbManSave.SqlStatement = _dbManSave.SqlStatement + " " + ProdmonthLbl.Text + ", '" + SectionLbl.Text + "', '" + fn + "' \r\n";
                _dbManSave.SqlStatement = _dbManSave.SqlStatement + " ) END TRY \r\n";

                _dbManSave.SqlStatement = _dbManSave.SqlStatement + "  BEGIN CATCH update tbl_PlanningImages set \r\n";
                _dbManSave.SqlStatement = _dbManSave.SqlStatement + "  ImageName = '" + fn + "' \r\n";
                _dbManSave.SqlStatement = _dbManSave.SqlStatement + " where Prodmonth = " + ProdmonthLbl.Text + " and  Section = '" + SectionLbl.Text + "' end catch \r\n ";
        ...
        private void panPic_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawLine(p, c.X, c.Y - rad, c.X, c.Y + rad);
        }
    }
}
