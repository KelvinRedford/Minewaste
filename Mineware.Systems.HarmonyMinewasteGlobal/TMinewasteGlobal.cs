...
{
    public static class TMinewasteGlobal
    {
        ...
        public static MinewasteMenuStructure MinewasteMenuStructure = new MinewasteMenuStructure();


        static TMinewasteGlobal()
        {
            
            MinewasteMenuStructure.setMenuItems();
        ...
        public static TSysSettings getSystemSettingsProductionInfo(string SiteTag)
        {
        ...
        {
            if (SystemSettingsProduction.Count == 0)
            {
