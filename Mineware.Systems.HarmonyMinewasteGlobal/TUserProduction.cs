       ...
       // private int m_BackDateBooking = 0;  //0 = none; 1 = one day; 2 = full;
        ...
        public void SetUserInfo(string UserID,string systemDBTag, string connection)
        {
            try
            {
                ...
                {
                    _dbMan.SqlStatement = String.Format("Select * from tbl_Users where UserID = '{0}'", UserID);
                    ...
                    clsDataResult dataresult = _dbMan.ExecuteInstruction();
                    ...
                    _dbMan.SqlStatement = "Select HierarchicalID from Section where ProdMonth = " + TMinewasteGlobal.getSystemSettingsProductionInfo(SiteTag).CurrentProductionMonth +
